...
else if (last_problem_bool[0] == 1) {
if (accum_straight_distance - y >= 0.55){
last_dropped = 1;return 1;}
else{
last_dropped = 0;
return 0;}
...
if (accum_straight_distance - y >= 0.75){
last_dropped = 1;return 1;}
else{last_dropped = 0;return 0;}
}
}
}
int crack_drop_bool_function(void){
...
if (accum_straight_distance - y >= 0.36){
last_dropped = 1;
return 1;
}
else{last_dropped = 0;return 0;
...
void record(char corh){
if (corh == 'c'){
array_cracks_distance[crack_counter] = (int) (accum_straight_distance*28.3);
crack_counter +=1;
if (last_sensed == 2){
LATDbits.LATD0 = 1;
LATDbits.LATD1 = 0;
_delay((unsigned long)((wety_deg)*(10000000/4000.0)));
}
